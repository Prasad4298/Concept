	...
	public :
		...
		// hence, declared again inside the public section...
			...
			void fun()
			{
				...
				cout<<end1<<"public member : "<<pub<<end1<<"Private member : "<<pri<<end1<<"Protected member : "<<pro<<end1;
			}
};	// class declaration ends here hence ";" is must at the end of class...
int demo::i = 10;			// intitialization of static member of class
...
int main()
{
    ...
    cout<<demo::i;			// static characteristic acces by using class name 
